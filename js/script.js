...
//SLIDERS
if ($('.body-main-slider').length > 0) {
	$('.body-main-slider').slick({
			...
			nextArrow: '<button type="button" class="control-main-slider-arrow control-main-slider-arrow__arrow-next"></button>',
			prevArrow: '<button type="button" class="control-main-slider-arrow control-main-slider-arrow__arrow-prev"></button>',
			// responsive: [{
			// 	breakpoint: 768,
			// 	settings: {}
			// }]
	...
	let controlMainSlider = document.querySelector(".control-main-slider");
	$(".body-main-slider").on('afterChange', function (event, slick, currentSlide) {
		controlMainSlider.classList.remove('hide');
		if (currentSlide == 3) {
			controlMainSlider.classList.toggle('hide');
		}
	 });
}
...
let contentSlider = document.querySelector(".content-item-body-main-slider");
let modelsSlider = document.querySelector(".models");
let controlSlider = document.querySelector(".control-main-slider");
...
if (iconMenu) {
	iconMenu.addEventListener("click", function () {
		...
		contentSlider.classList.toggle("active");
		modelsSlider.classList.toggle("active");
		controlSlider.classList.toggle("active");
	});
}

let modelsCategory01 = document.querySelector(".models-categories__category_01");
let hoverModels01 = document.querySelector(".hover-models_01");

let modelsCategory02 = document.querySelector(".models-categories__category_02");
let hoverModels02 = document.querySelector(".hover-models_02");

let modelsCategory03 = document.querySelector(".models-categories__category_03");
let hoverModels03 = document.querySelector(".hover-models_03");

modelsCategory01.addEventListener("click", function () {
	modelsCategory02.classList.remove("active");
	hoverModels02.classList.remove("active");
	modelsCategory03.classList.remove("active");
	hoverModels03.classList.remove("active");

	modelsCategory01.classList.toggle("active");
	hoverModels01.classList.toggle("active");
});

modelsCategory02.addEventListener("click", function () {
	modelsCategory01.classList.remove("active");
	hoverModels01.classList.remove("active");
	modelsCategory03.classList.remove("active");
	hoverModels03.classList.remove("active");

	modelsCategory02.classList.toggle("active");
	hoverModels02.classList.toggle("active");
});

modelsCategory03.addEventListener("click", function () {
	modelsCategory01.classList.remove("active");
	hoverModels01.classList.remove("active");
	modelsCategory02.classList.remove("active");
	hoverModels02.classList.remove("active");

	modelsCategory03.classList.toggle("active");
	hoverModels03.classList.toggle("active");
});
...
$(function () {
	...
	$(window).scroll(function () {
		...
		if (scroll >= 40) {
			...
			$(".menu__link--log").addClass('active');
		} else {
			$(".header").removeClass('active');
			$(".menu__link--log").removeClass('active');
		}
	});
});